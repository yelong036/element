<script>
  ...
  import ElButton from 'element-ui-liusq/packages/button';
  import ElButtonGroup from 'element-ui-liusq/packages/button-group';
  import { generateId } from 'element-ui-liusq/src/utils/util';
